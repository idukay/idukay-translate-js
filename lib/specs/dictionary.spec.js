...
describe('Dictionary', function () {
  ...
  var locales = ['./specs/locales/en-us', './specs/locales/es-ec'];

  describe('es-ec', function () {
    beforeEach(function () {
      dictionaryInstance = (0, _dictionary2.default)({ id: 'es-ec', locales: locales });
    });
  ...
  describe('en-us', function () {
    beforeEach(function () {
      dictionaryInstance = (0, _dictionary2.default)({ id: 'en-us', locales: locales });
    });
