...
describe('Dictionary', function () {
  ...
  describe('es-ec', function () {
    beforeEach(function () {
      (0, _dictionary2.default)({ id: 'es-ec', dictionaries: dictionaries });
    });
  ...
  describe('en-us', function () {
    beforeEach(function () {
      (0, _dictionary2.default)({ id: 'en-us', dictionaries: dictionaries });
    });
  ...
  describe('when dictionary not exist', function () {
    beforeEach(function () {
      (0, _dictionary2.default)({ id: 'notExist', dictionaries: dictionaries });
    });
  ...
  describe('when dictionary instance without id', function () {
    beforeEach(function () {
      ...
      (0, _dictionary2.default)({ dictionaries: newDictionaries });
    });
